...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-leader', 'hr-manager', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Ritual', path: '/rituals', entity: 'ritual', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    {
      name: 'Ritual Participant',
      path: '/ritual-participants',
